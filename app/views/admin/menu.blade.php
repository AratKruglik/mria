...
@section('title')
  @if(isset($item)){{ $item->name }} @else Додати @endif | Головне меню
@stop
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        @if(isset($item)) {{ $item->name }} - Змінити пункт меню @else Додати пункт меню @endif
      </header>
      <div class="panel-body">
        ...
        @else 
          {{ Form::open(['action' => 'DashboardController@menuAdd', 'method' => 'post', 'class' => 'form-horizontal tasi-form']) }} 
        @endif
