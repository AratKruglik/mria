            	...
            	<div class="col-md-6">
                    <div class="row">
                        <div class="col-sm-6 footer-column onscroll-animate">
                            ...
                            <p>Тут описання компанії з її перевагами</p>
                            <a href="#" class="read-more-link-alt">детальніше</a>
                        </div>
                        ...
                        <div class="col-sm-6 footer-column font-normal onscroll-animate" data-delay="600">
                            ...
                            <div class="icon-opening-wrapper">
                                <div class="icon-opening-container">
                                    ...
                                    <div class="icon-opening-content">0 800 123 456 78</div>
                                </div>
                            </div>
                            <div class="icon-opening-wrapper">
                                <div class="icon-opening-container">
                                    <div class="icon-opening"><i class="fa fa-envelope"></i></div>
                                    <div class="icon-opening-content">info@mria.com</div>
                                </div>
                            </div>
                            <div class="icon-opening-wrapper">
                                <div class="icon-opening-container">
                                    <div class="icon-opening"><i class="fa fa-globe"></i></div>
                                    <div class="icon-opening-content">00000, Київ, вул. Вулиця, буд. 1</div>
                                </div>
                            </div>
                        </div>
